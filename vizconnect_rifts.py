		...
		if initFlag&vizconnect.INIT_MAPPINGS:
			...
			if initFlag&vizconnect.INIT_MAPPINGS_PER_FRAME:
				...
				def update(transport):
					if rawInput['right_touch_controller'].getStick()[1] > 0.01:# make=Oculus VR, model=Touch Controller, name=right_touch_controller, signal=Stick Up
						transport.moveForward(mag=abs(rawInput['right_touch_controller'].getStick()[1]))
					if rawInput['right_touch_controller'].getStick()[1] < -0.01:# make=Oculus VR, model=Touch Controller, name=right_touch_controller, signal=Stick Down
						transport.moveBackward(mag=abs(rawInput['right_touch_controller'].getStick()[1]))
					if rawInput['right_touch_controller'].getStick()[0] < -0.01:# make=Oculus VR, model=Touch Controller, name=right_touch_controller, signal=Stick Left
						transport.moveLeft(mag=abs(rawInput['right_touch_controller'].getStick()[0]))
					if rawInput['right_touch_controller'].getStick()[0] > 0.01:# make=Oculus VR, model=Touch Controller, name=right_touch_controller, signal=Stick Right
						transport.moveRight(mag=abs(rawInput['right_touch_controller'].getStick()[0]))
					if rawInput['left_touch_controller'].getStick()[1] > 0.01:# make=Oculus VR, model=Touch Controller, name=left_touch_controller, signal=Stick Up
						transport.moveUp(mag=abs(rawInput['left_touch_controller'].getStick()[1]))
					if rawInput['left_touch_controller'].getStick()[1] < -0.01:# make=Oculus VR, model=Touch Controller, name=left_touch_controller, signal=Stick Down
						transport.moveDown(mag=abs(rawInput['left_touch_controller'].getStick()[1]))
